package com.proyectos.literatura.service;

import com.proyectos.literatura.api.PeticionAPI;
import com.proyectos.literatura.model.Autor;
import com.proyectos.literatura.model.Idioma;
import com.proyectos.literatura.model.Libro;
import com.proyectos.literatura.model.LibroRecord;
import com.proyectos.literatura.util.JsonParser;
...
public class MenuService {
    ...
    public void guardarLibro() {
        ...
        for (int indice = 0; indice < librosObtenidos.size(); indice++) {
            System.out.println((indice + 1) + " - " + librosObtenidos.get(indice).titulo() + " - " + librosObtenidos.get(indice).idiomas().get(0) + " - " + librosObtenidos.get(indice).autores().get(0).nombre());
        }
    ...
    public List<LibroRecord> obtenerLibrosApi() {
        ...
        librosObtenidos = jsonParser.parsearLibros(peticionAPI.obtenerDatosApiGutendex(titulo));
